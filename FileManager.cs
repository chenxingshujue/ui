            ...
            for (var gnomes = 1; gnomes <= magicDust; gnomes++) 
            {
                    ...
                    foreach (string fileName in filesName)
                    {
                        ...
                        { // System.IO.IOException: The directory is not empty
                            ...
                            sw.util.LoggerHelper.Warning("File.Delete Gnomes prevent deletion of" + path + "! Applying magic dust, attempt #" + gnomes + " errorMsg:" + mensaje);
                            Thread.Sleep(50);
                            continue;
                        }
                    ...
                    { // System.IO.IOException: The directory is not empty
                        ...
                        sw.util.LoggerHelper.Warning("Directory.Delete Gnomes prevent deletion of" + path + "! Applying magic dust, attempt #" + gnomes + " errorMsg:" + mensaje);
                        Thread.Sleep(50);
                        continue;
                    }
